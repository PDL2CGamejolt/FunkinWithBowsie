...
class Achievements {
	public static function init()
	{
		...
		createAchievement('bowweek_nomiss',			{name: "Beating an Immortal", description: "Beat Week Bow with no Misses."});
		createAchievement('preliminary',			{name: "Throwin' It Back", description: "Beat Preliminary", hidden: true});
